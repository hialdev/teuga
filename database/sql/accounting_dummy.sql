...
-- Dumping data for table teuga_accounting.banks: ~2 rows (approximately)
REPLACE INTO `banks` (`id`, `account_id`, `bank_name`, `logo`, `account_number`, `account_name`, `description`, `created_at`, `updated_at`) VALUES
	('40c9a42a-211c-4723-82a3-d8d1dda03f63', NULL, 'Bank Central Asia (BCA)', 'banks/rjIsh0jJ0rrI1PWv7IrUz2CypzNschOXE8JTxw01.webp', 123456789, 'Muhammad Nur Alif', NULL, '2025-02-24 04:31:11', '2025-02-24 04:31:11'),
	('42c6b19a-cb2f-4ba3-b0a3-1329fa784436', NULL, 'Bank Nasional Indonesia (BNI)', NULL, 123456789009876, 'PT Rizq Sahara Multindo', NULL, '2025-02-24 04:33:06', '2025-02-24 04:33:06');
