    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Add New Application</h4>
    ...
    <div class="row">
        <div class="col-md-4 h-100 mb-3">
            <div id="placeholder-image"
                class="d-flex p-5 text-center rounded-3 align-items-center justify-content-center border-2 border-dashed"
            >
                <div>
                    <div class="fs-4">If Image Selected, it will show (Preview)</div>
                </div>
            </div>
            <img src="" id="preview-image" alt="Flyer Image Preview" class="d-none shadow w-100"
                style="object-fit:cover;">
        </div>
        <div class="col-md-8">
            <div class="card">
                <div class="px-4 py-3 border-bottom">
                    <h5 class="card-title fw-semibold mb-0">Add Application</h5>
                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="icon" class="form-control ps-2"
                                    placeholder="Icon Aplikasi" value="{{old('icon')}}">
                            </div>
                            @error('icon')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control ps-2"
                                            placeholder="Nama Aplikasi" value="{{old('name')}}">
                                    </div>
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="code" class="form-control ps-2"
                                            placeholder="Kode unik penanda Aplikasi" value="{{old('code')}}">
                                    </div>
                                    @error('code')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="url" class="form-control ps-2"
                                    placeholder="Link Aplikasi, e.g http://domain.com" value="{{old('url')}}">
                            </div>
                            @error('url')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
