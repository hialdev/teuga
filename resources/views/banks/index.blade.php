                                ...
                                <td>
                                    <div class="d-flex align-items-center" >
                                        <img src="{{ $bank->logo ? asset('storage/' . $bank->logo) : '/assets/images/profile/user-1.jpg' }}"
                                            class="rounded-2" alt="Bank Logo {{ $bank->bank_name }}" style="width: 4em" />
                                        <div class="ms-3">
                                            <div class="d-flex mb-1 fs-2 align-items-center gap-2">
                                                <div class="fs-1 badge bg-primary text-white">{{ $bank->account ? $bank->account->full_code : '?'}}</div>
                                                {{ $bank->account ? $bank->account->account_name : 'Belum dikaitkan ke Account' }}
                                            </div>
                                            <h6 class="fw-semibold mb-1">{{ $bank->bank_name }}</h6>
                                            <span class="fw-normal text-muted line-clamp line-clamp-2"
                                                style="white-space:normal; font-size:13px; ">{{ $bank->description }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="fs-4 fw-bold text-dark">a.n {{$bank->account_name}}</div>
                                    <div class="fs-3 fw-bold text-primary">{{$bank->account_number}}</div>
                                </td>
                                <td>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                            <div class="modal-content p-3 modal-filled bg-danger">
                                                ...
                                                <div class="modal-body" style="width: fit-content; white-space:normal">
                                                    <h5 class="mt-0 text-white">Bank {{$bank->bank_name}} akan dihapus</h5>
