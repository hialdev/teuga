    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Kelola Logistic : {{ $logistic->name }}</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="{{ route('logistic.index') }}">Logistic</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Kelola {{ $logistic->name }}</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <div class="">
        <div class="stepper">
            <div class="step active" data-step="1">
                ...
                <div class="label fs-2">Data Logistic</div>
                <div class="line"></div>
            </div>
            ...
            <div class="step" data-step="3">
                ...
                <div class="label fs-2">Narahubung</div>
            </div>
        </div>
        ...
        <div id="stepper-form">
            <div class="step-content active" data-step="1">
                <div class="card" id="view-principal">
                    <div class="px-4 py-3 border-bottom w-100">
                                    ...
                                    <div class="modal-content p-3 modal-filled bg-danger">
                                        <div class="modal-header modal-colored-header text-white">
                                            <h4 class="modal-title text-white" id="danger-header-modalLabel">
                                                Yakin ingin menghapus Logistic {{$logistic->name}} ?
                                            </h4>
                                            <button type="button" class="btn-close btn-close-white"
                                                data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body" style="width: fit-content; white-space:normal">
                                            <h5 class="mt-0 text-white">Client {{$logistic->name}} akan dihapus</h5>
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-3 w-100" style="width:15em">
                            ...
                            <div class="ms-auto">
                                <a href="#alamat" class="btn btn-light btn-sm rounded-pill p-2 px-3 mb-2"><i class="ti ti-map-2 fs-3 me-2"></i>{{ $logistic->addresses->count() }} Alamat Lainnya</a>
                            </div>
                        </div>
                ...
                <div class="row d-none" id="edit-principal">
                    <div class="col-md-4 h-100 mb-3">
                        @if($logistic->image)
                        <img src="{{ '/storage/'.$logistic->image }}" alt="principal Image Preview" class="rounded-4 shadow w-100"
                            style="">
                        @else
                        ...
                        <div class="card">
                            <div class="px-4 py-3 border-bottom">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h5 class="card-title fw-semibold mb-3">Perbarui Logistic</h5>
                                    <div class="ms-auto">
                                ...
                                <form action="{{ route('logistic.update', $logistic->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" value="{{ old('name', $logistic->name) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text px-6" id="basic-addon1"><i
                                                    class="ti ti-text-caption fs-6"></i></span>
                                            <input type="number" name="npwp" value="{{ old('npwp', $logistic->npwp) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="email" value="{{ old('email', $logistic->email) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="phone" value="{{ old('phone', $logistic->phone) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text px-6" id="basic-addon1"><i
                                                            class="ti ti-phone fs-6"></i></span>
                                                    <input type="number" name="fax" value="{{ old('fax', $logistic->fax) }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control ps-2" name="description" id="description" cols="20" rows="5"
                                                placeholder="Description about this Logistic">{{ old('description', $logistic->description) }}</textarea>
                                        </div>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <select name="city" id="city_primary" class="select2-normal form-select">
                                                                ...
                                                                @foreach ($cities as $city)
                                                                    <option value="{{$city->city_name}}" {{ $city->city_name == old('city', $logistic->city) ||  $city->city_name == old('city', strtoupper($logistic->city)) ? 'selected' : '' }}>
                                                                        {{ $city->city_name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text px-6" id="basic-addon1"><i
                                                                class="ti ti-text-caption fs-6"></i></span>
                                                        <input type="text" name="postal_code" value="{{ old('postal_code', $logistic->postal_code) }}"
                                        ...
                                        <div class="">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control bg-white ps-2" name="address" id="address" cols="20" rows="5"
                                                    placeholder="Alamat utama Logistic">{{ old('address', $logistic->address) }}</textarea>
                                            </div>
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    {{ $message }}
                                    ...
                                    <button type="submit" class="btn btn-primary next-step">Perbarui Data Logistic</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="step-content" data-step="2" style="display: none;">
                <div class="d-flex mb-3 align-items-center gap-3">
                    ...
                    <div class="d-flex align-items-center justify-content-center bg-primary text-white p-2 rounded-circle" style="aspect-ratio:1/1; width:2.5em; height:2.5em">{{ count($logistic->addresses) }}</div>
                    @if($logistic->addresses->count() > 0)
                    <div class="ms-auto">
                                        ...
                                        <div class="dropdown dropstart">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a href="#" class="dropdown-item text-secondary d-flex align-items-center gap-3 editAddressBtn" 
                                                    ...
                                                    data-url="{{ route('logistic.address.update', ['id' => $logistic->id, 'address_id' => $address->id]) }}" 
                                                ...
                                                <li>
                                                    <button type="button" class="dropdown-item d-flex align-items-center gap-3 delAddressBtn"
                                                        ...
                                                        data-id="{{$address->id}}" 
                                                        data-name="{{$address->name}}" 
                                                        data-url="{{ route('logistic.address.destroy', ['id' => $logistic->id, 'address_id' => $address->id]) }}" 
                                                        ><i
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('logistic.address.store', $logistic->id) }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text px-6" id="basic-addon1"><i
                                                    class="ti ti-map-2 fs-6"></i></span>
                                            <textarea class="form-control bg-white ps-2" name="address" id="address" cols="20" rows="5"
                                                placeholder="Alamat Lainnya Logistic">{{ old('address') }}</textarea>
                                        </div>
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                ...
                <div id="deleteAddressModal" class="modal fade" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content p-3 modal-filled bg-danger">
                            ...
                            <div class="modal-body" style="width: fit-content; white-space:normal">
                                <h5 class="mt-0 text-white">Alamat Logistic  <span class="address_name"></span> akan dihapus</h5>
                                <p class="text-white">Segala data yang berkaitan dengan alamat tersebut juga akan dihapus secara permanen.</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-light" data-bs-dismiss="modal">
            ...
            <div class="step-content" data-step="3" style="display: none;">
                <div class="d-flex mb-3 align-items-center gap-3">
                    ...
                    <h5 class="mb-0">Narahubung</h5>
                </div>

                <div class="row" id="showPICSales">
                    <div class="col-md-4 col-lg-3 mb-2">
                        <div class="card">
                            <div class="card-body p-4 h-100 d-flex flex-column position-relative">
                                <img src="{{'/assets/images/profile/user-4.jpg'}}" alt="Image Narahubung Placholder" class="img-fluid rounded-circle bg-light border border-primary mb-4"
                                    width="80" height="80" style="aspect-ratio:1/1; object-fit:cover;">
                                <h5 class="fw-semibold fs-4">{{$logistic->cp_name ?? 'Nama belum diset'}}</h5>
                                <div class="mb-2 d-flex align-items-center gap-2"><i class="ti ti-mail"></i>{{$logistic->cp_email ?? 'email belum diset'}}</div>
                                <div class="d-flex align-items-center gap-2"><i class="ti ti-phone"></i>{{$logistic->cp_phone ?? 'nomor belum diset'}}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-lg-9">
                        <div class="card">
                            <div class="px-4 py-3 border-bottom">
                                <h5 class="card-title fw-semibold mb-0">Perbarui Narahubung</h5>
                            </div>
                            <div class="card-body p-4">
                                @if ($errors->any())
                                    <div class="alert alert-danger">
                                ...
                                @endif
                                <form action="{{ route('logistic.cp', ['id' => $logistic->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-4">
                                                <label class="form-label fw-semibold">Nama Narhubung</label>
                                                <div class="input-group">
                                                    <span class="input-group-text px-6" id="basic-addon1"><i
                                                            class="ti ti-user-circle fs-6"></i></span>
                                                    <input type="text" name="cp_name" class="form-control ps-2"
                                                        placeholder="Nama Narahubung" value="{{old('cp_name', $logistic->cp_name)}}">
                                                </div>
                                                @error('cp_name')
                                                    <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text px-6" id="basic-addon1"><i
                                                            class="ti ti-mail fs-6"></i></span>
                                                    <input type="email" name="cp_email" class="form-control ps-2"
                                                        placeholder="user@mail.com" value="{{old('cp_email', $logistic->cp_email)}}">
                                                </div>
                                                @error('cp_email')
                                                    <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text px-6" id="basic-addon1"><i
                                                            class="ti ti-phone fs-6"></i></span>
                                                    <input type="number" name="cp_phone" class="form-control ps-2"
                                                        placeholder="62xxx" value="{{old('cp_phone', $logistic->cp_phone)}}">
                                                </div>
                                                @error('cp_phone')
                                                    <span class="invalid-feedback" role="alert">
                                                        {{ $message }}
                                    ...
                                    <button type="submit" class="btn btn-primary">Perbarui Narahubung</button>
                                </form>
                            </div>
                        </div>
                    </div>
