                ...
                <div class="card mb-0 rounded-4">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login.email') }}">
                            @csrf
                            <div class="mb-3">
                                <label for="email" class="form-label">Email Terdaftar Anda</label>
                                <input type="email" name="email" placeholder="registered@mail.com" class="form-control @error('email') is-invalid @enderror" id="email" aria-describedby="emailHelp" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
                            ...
                            <button class="btn btn-primary w-100 py-8 mb-2 rounded-2">Kirim OTP</button>
