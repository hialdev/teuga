                            ...
                            <tr>
                                ...
                                <td>
                                    @if($tpInvoice->transport)
                                        <a href="{{route('purchase-order.setting', $tpInvoice->transport->id)}}" target="_blank" class="border border-primary p-1 px-2 rounded-2 d-inline-flex align-items-center fs-2 mb-1 gap-2">
