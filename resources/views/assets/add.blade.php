    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-3">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Tambah Aset Tetap</h4>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="px-4 py-3 border-bottom">
                    <h5 class="card-title fw-semibold mb-0">Tambah Aset Tetap</h5>
                </div>
                    ...
                    <form action="{{ route('asset.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" value="{{old('name')}}" class="form-control ps-2" placeholder="Nama Asset">
                            </div>
                            @error('name')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control ps-2" name="description" id="description" cols="20" rows="5"
                                    placeholder="description Aset Tetap">{{old('description')}}</textarea>
                            </div>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                        ...
                        <div class="p-3 rounded-3 bg-primary-subtle mb-3">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="date" value="{{old('date')}}" class="form-control bg-white ps-2" placeholder="Tanggal Pembelian Asset">
                                </div>
                                @error('date')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                            ...
                            <div class="">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="purchase_price" value="{{formatRupiah(old('purchase_price'))}}" class="input-rupiah form-control bg-white ps-2" placeholder="Harga Beli">
                                </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" name="is_appreciating" type="checkbox" value="1" id="is_appreciating" {{old('is_appreciating') ? 'checked' : ''}} />
                                <label class="form-check-label" for="is_appreciating">Nilai Aset Tetap ini terus bertambah</label>
                            </div>
                        </div>
                        <div class="p-3 rounded-3 bg-primary-subtle mb-3 {{old('is_appreciating') ? '' : 'd-none'}}" id="appreciate-box">
                            <label class="form-label fw-semibold">Presepsi Pertambahan nilai (%)</label>
                            <div class="input-group">
                                <span class="input-group-text px-6" id="basic-addon1"><i
                                        class="ti ti-percentage fs-6"></i></span>
                                <input type="text" name="appreciation_rate" value="{{old('appreciation_rate')}}" class="form-control bg-white ps-2" placeholder="Persentase kenaikan setiap tahun">
                            </div>
                        ...
                        <div class="p-3 mb-3 rounded-3 bg-primary-subtle {{old('is_appreciating') ? 'd-none' : ''}}" id="depreciate-box">
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Masa Manfaat (Usefull Life) dalam tahun</label>
                                <div class="input-group">
                                    <span class="input-group-text px-6" id="basic-addon1"><i
                                            class="ti ti-clock fs-6"></i></span>
                                    <input type="number" name="usefull_life" value="{{old('usefull_life')}}" class="form-control bg-white ps-2" placeholder="Berapa tahun masa guna pakai aset ini ?">
                                </div>
                                @error('usefull_life')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                            ...
                            <div class="mb-0">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text px-6" id="basic-addon1"><i
                                            class="ti ti-currency-dollar fs-6"></i></span>
                                    <input type="text" name="residu_price" value="{{formatRupiah(old('residu_price'))}}" class="input-rupiah form-control bg-white ps-2" placeholder="Perkiraan harga terakhir setelah masa guna habis">
                                </div>
                                @error('residu_price')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
