...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Laporan Arus Kas</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="pdfReportForm">
                        ...
                        <input type="hidden" id="bladePath" name="bladePath" value="pdf.reports.cash_flow">
    ...
    <div class="row align-items-end mb-3 flex-wrap">
        ...
        <div class="col-md-2 mb-2">
            <div class="d-flex align-items-center gap-1">
                ...
                <a href="{{route('report.cash-flow')}}" class="btn btn-secondary" style="white-space: nowrap">
        ...
        <tbody>
            ...
            @forelse ($cashFlows as $flow)
                ...
                <tr>
                    ...
                    <td>{{ $flow->description ?? $flow->transaction->description }}</td>
