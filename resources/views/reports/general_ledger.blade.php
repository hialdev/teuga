...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Buku Besar (General Ledger)</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="javascript:void(0);">Laporan Keuangan</a>
                        </li>
                        <li class="breadcrumb-item" aria-current="page">Buku Besar (General Ledger)</li>
                    </ol>
                </nav>
            </div>
            <div class="col-3">
...
<div class="mb-3 d-flex align-items-center gap-2 justify-content-between">
    <h1>Laporan Buku Besar (General Ledger)</h1>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="pdfReportForm">
                        ...
                        <input type="hidden" id="bladePath" name="bladePath" value="pdf.reports.general_ledger">
    ...
    <div class="row align-items-end mb-3 flex-wrap">
        ...
        <div class="col-md-2 mb-2">
            <div class="d-flex align-items-center gap-1">
                ...
                <a href="{{route('report.general-ledger')}}" class="btn btn-secondary" style="white-space: nowrap">
...
<div class="">
    ...
    @forelse ($groupedLedger as $accountCode => $entries)
        <div class="d-flex align-items-center gap-3 mb-3">
            {{-- <div class="bg-primary rounded-4" style="width:4em;height:2px;"></div> --}}
            <div class="badge bg-primary">{{ $accountCode }}</div>
            <h5 class="mb-0">{{ $entries->first()->account->account_name }} </h5>
        </div>
    ...
    @empty
            <div class="p-4 border border-dashed border-primary rounded-3">
                <div class="text-center">Tidak ada data pada Priode yang dipilih</td>
            </div>
    @endforelse
</div>
@endsection
