...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
    <div class="card-body px-4 py-3">
        <div class="row align-items-center">
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Laporan Laba Rugi (Income Statement)</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="javascript:void(0);">Laporan Keuangan</a>
                        </li>
                        <li class="breadcrumb-item" aria-current="page">Laporan Laba Rugi (Income Statement)</li>
                    </ol>
                </nav>
            </div>
            <div class="col-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="pdfReportForm">
                        ...
                        <input type="hidden" id="bladePath" name="bladePath" value="pdf.reports.income_statement">
    ...
    <table class="table table-bordered">
        <thead class="table-success">
            <tr>
                ...
                <th>Akun</th>
                <th>Deskripsi</th>
                <th class="text-end">Kredit (Pendapatan)</th>
            </tr>
        </thead>
        <tbody>
        ...
        <tfoot>
            <tr>
                ...
                <th class="text-end">{{ formatRupiah($totalRevenue) }}</th>
            </tr>
        </tfoot>
    </table>
    ...
    <table class="table table-bordered">
        <thead class="table-danger">
            <tr>
                ...
                <th>Akun</th>
                <th>Deskripsi</th>
                <th class="text-end">Debet (Beban)</th>
            </tr>
        </thead>
        <tbody>
        ...
        <tfoot>
            <tr>
                ...
                <th class="text-end">{{ formatRupiah($totalExpense) }}</th>
            </tr>
        </tfoot>
    </table>
